...
public class ExcelDataProvider {
	...
	public static XSSFWorkbook excelData(String bu1) {
	
		try {
			if(bu1.equals("BU1"))
			{
				//BU1 FILE PATH
			wb=new XSSFWorkbook(new FileInputStream(new File("D:\\1 PROJECTS\\7 PHOENIX\\2020\\PSI PROJECTS\\BU1_Customers.xlsx")));
			...
			{//BU3 FILE PATH
				...
				wb=new XSSFWorkbook(new FileInputStream(new File("D:\\1 PROJECTS\\7 PHOENIX\\2020\\PSI PROJECTS\\Testing\\PCR_Import_MY18_01_P0280.xlsx")));
			}
		}catch (IOException e) {
