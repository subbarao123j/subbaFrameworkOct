...
public class AddTemplateAndNOPromote {
	...
	driver.findElement(By.xpath("//a[text()='3']")).click();
	 ...
	 Thread.sleep(5000);
	//*[@id="forecast-project-grid"]
	 
	//*[@id="forecast-project-grid"]/div[2]
	 
	//*[@id="forecast-project-grid"]/div[2]/table/tbody/tr[1]/td[2]
	 int count=0;
